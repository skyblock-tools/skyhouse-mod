...
public class ThemeManager {
    ...
    public static int getColour(String... props) {
        ...
        JsonObject head = DataManager.themes.get(SkyhouseMod.INSTANCE.getConfig().generalConfig.theme).getAsJsonObject();
    ...
    public static void drawAhOverlayThemeFor(String gui) {
        ...
        if (DataManager.themes.get(SkyhouseMod.INSTANCE.getConfig().generalConfig.theme).getAsJsonObject().has(gui)) {
            JsonArray lines = DataManager.themes.get(SkyhouseMod.INSTANCE.getConfig().generalConfig.theme).getAsJsonObject().get(gui).getAsJsonObject().get("lines").getAsJsonArray();
